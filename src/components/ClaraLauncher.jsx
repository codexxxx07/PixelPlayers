    ...
    <div className="fixed z-50 right-3 bottom-3 sm:right-6 sm:bottom-6">
      {open && (
        <div className="absolute right-0 bottom-[76px] w-[min(92vw,400px)] max-h-[76vh] flex flex-col rounded-3xl bg-white border-2 border-teal-100 shadow-2xl shadow-teal-900/25 overflow-hidden animate-slide-up">
          <div className="flex items-center gap-3 px-4 py-3 bg-linear-to-r from-teal-50 to-amber-50 border-b border-teal-100">
            <ClaraBadge className="w-11 h-11 shrink-0" />
            ...
            <button
              ...
              className="shrink-0 flex items-center justify-center w-9 h-9 rounded-xl bg-white border-2 border-teal-200 hover:bg-teal-50 text-teal-800 text-sm transition-colors"
            >
              <span aria-hidden="true">↻</span>
            </button>
            <Link
              to="/assistant"
              className="shrink-0 inline-flex items-center gap-1 rounded-xl bg-white border-2 border-teal-200 hover:bg-teal-50 text-teal-800 px-3 py-1.5 text-xs font-bold transition-colors"
            >
              {t("chat.fullChat")}
              <span aria-hidden="true">→</span>
            </Link>
            ...
            <div className="border-t border-teal-100 bg-white px-4 py-3" aria-live="polite">
              {voiceState === "listening" ? (
                <div className="flex items-center gap-3">
                  <ClaraBadge className="w-10 h-10 shrink-0" />
                  ...
                  <button
                    type="button"
                    onClick={stopVoice}
                    className="shrink-0 inline-flex items-center gap-1.5 rounded-xl bg-white border-2 border-red-200 hover:bg-red-50 text-red-600 px-3 py-2 text-xs font-bold transition-colors"
                  >
                    <span aria-hidden="true">⏹</span>
                    {t("assistant.stop")}
                  </button>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="inline-block w-6 h-6 rounded-full border-4 border-teal-200 border-t-teal-600 animate-spin shrink-0" aria-hidden="true" />
                </div>
              )}
            </div>
          )}
          ...
          <div className="px-4 pt-3 flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            {SUGGESTIONS.map((suggestion) => (
              <button
                ...
                className="shrink-0 inline-flex items-center gap-2 whitespace-nowrap rounded-full border-2 border-teal-200 bg-white hover:bg-teal-50 text-teal-800 px-3 py-2 text-xs font-bold transition-colors"
              >
      ...
      <button
        ...
        aria-expanded={open}
        className="relative z-10 flex items-center justify-center w-16 h-16 rounded-full bg-linear-to-b from-teal-400 to-teal-600 border-2 border-teal-700/40 shadow-[inset_0_2px_0_rgba(255,255,255,0.35),0_6px_16px_rgba(19,78,74,0.35)] hover:brightness-105 active:scale-95 transition-all overflow-hidden"
      >
